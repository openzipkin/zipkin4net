...
namespace zipkin4net.Tracers.Zipkin
{
    internal class ZipkinAnnotationVisitor : IAnnotationVisitor
    {
        ...
        {
            _span.RemoteEndPoint(new Internal.V2.Endpoint(messageAddr.ServiceName, messageAddr.Endpoint));
        }
        ...
        {
            _span.LocalEndpoint(new Internal.V2.Endpoint(serviceName.Service, SerializerUtils.DefaultEndPoint));
        }

        public void Visit(LocalAddr localAddr)
        {
            _span.LocalEndpoint(new Internal.V2.Endpoint(SerializerUtils.DefaultServiceName, localAddr.EndPoint));
        }
        ...
        public void Visit(ClientAddr clientAddr)
        {
            ...
            _span.RemoteEndPoint(new Internal.V2.Endpoint(serviceName, clientAddr.Endpoint));
        }

        public void Visit(ServerAddr serverAddr)
        {
            _span.RemoteEndPoint(new Internal.V2.Endpoint(serverAddr.ServiceName, serverAddr.Endpoint));
        }
